		...
		jade: {
			compile: {
				...
				files: [{
					expand: true,
					cwd: '<%= app %>/',
					src: ['**/*.jade', '!**/navigation-header.jade', '!**/hero-shot.jade', '!**/whats-new.jade', '!**/enroll.jade', '!**/find-your-fit.jade', '!**/saved-a-space.jade', '!**/fifty-eight-quality-choices.jade', '!**/save-time-money.jade', '!**/find-fun.jade', '!**/header.jade', '!**/footer.jade'],
					ext: '.html',
					dest: '<%= app %>/'
				}]
			}
